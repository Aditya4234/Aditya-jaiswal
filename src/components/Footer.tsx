...
const socialLinks = [
  ...
  { icon: InstagramIcon, href: "https://instagram.com/adityajaiswal", label: "Instagram" },
];

const contactDetails = [
  { icon: Phone, value: "+91 9236580156" },
  { icon: Mail, value: "aditya9236580156@gmail.com" },
  { icon: MapPin, value: "Lucknow" },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-1 text-sm text-[var(--foreground)]/60">
            <span>&copy; {new Date().getFullYear()} Aditya Jaiswal.</span>
          ...
          <div className="flex items-center gap-6">
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-9 h-9 rounded-full border border-[var(--border)] bg-[var(--card)] flex items-center justify-center text-[var(--foreground)]/60 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 hover:text-white hover:border-transparent transition-all duration-300"
            ...
            <div className="hidden md:flex items-center gap-5 text-sm text-[var(--foreground)]/50">
        ...
        <div className="mt-8 pt-6 border-t border-[var(--border)] flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-[var(--foreground)]/60">
